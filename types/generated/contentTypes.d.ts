...
export interface ApiTechcategoryTechcategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'techcategories';
  info: {
    displayName: 'techcategory';
    pluralName: 'techcategories';
    singularName: 'techcategory';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::techcategory.techcategory': ApiTechcategoryTechcategory;
